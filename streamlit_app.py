...
if "kcal_min" in locals() and "kcal_max" in locals() and "bgp" in locals() and "bdp" in locals():
    st.write("Les besoins caloriques sont de **{round(kcal_min, 1)} kcal/j** à **{round(kcal_max, 1)} kcal/j**.")
    st.write("Les besoins en protéines sont de **{round(bgp, 1)} g/j** à **{round(bdp, 1)} g/j**.")
